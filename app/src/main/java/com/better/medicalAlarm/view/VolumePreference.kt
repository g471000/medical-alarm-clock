...
package com.better.medicalAlarm.view
...
import com.better.medicalAlarm.background.PluginAlarmData
import com.better.medicalAlarm.background.TargetVolume
import com.better.medicalAlarm.configuration.Prefs
import com.better.medicalAlarm.configuration.Prefs.Companion.MAX_PREALARM_VOLUME
...
import com.better.medicalAlarm.util.subscribeIn
...
class VolumePreference(mContext: Context, attrs: AttributeSet) : Preference(mContext, attrs) {
  ...
  /** Called from [com.better.medicalAlarm.presenter.SettingsFragment.onResume] */
  fun onResume() {
  ...
  /** Called from [com.better.medicalAlarm.presenter.SettingsFragment.onPause] */
  fun onPause() {
    stopMasterSample()
    stopPrealarmSample()
  }
